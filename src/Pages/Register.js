...
const Register = () => {
  ...
  const handleChange = (e) => {
    setData({ ...data, [e.target.name]: e.target.value }); // ...data = copie de data, [e.target.name] = nom de l'input, e.target.value = valeur de l'input pour pouvoir  modifier les données du formulaire
  };
